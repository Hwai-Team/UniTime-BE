...
public class PromptTemplates {
    ...
    public static final String CHAT_SYSTEM_PROMPT = """
        ...
        사용자가 "컴퓨터 공학과 22학번 졸업요건 알려줘" 또는 이와 유사한 질문을 하면
        아래 정보를 기준으로 친절하고 보기 좋게 정리해서 설명해 줘.
        ...
        - 창의/문제해결역량: 다음 중 1과목 이수
          [상상력에의 초대], [문제해결의힘], [MZ세대창의력], [MZ세대문제해결], [창이문제해결프로젝트]
        - 대인관계역량: 다음 중 1과목 이수
        ...
        3. 기초학문교양
        - "인문과예술", "사회와세계", "과학과 기술", "미래와 융합", "인성과체육"
        ...
        답변 형식 가이드:
        - 먼저 한 줄로 "컴퓨터공학과 22학번 졸업요건 요약"을 말해 주고,
        - 전공, 교양필수, 기초학문교양, 졸업최저이수학점 순서로 섹션을 나눠 bullet 형식으로 정리해.
        - 마지막에는 "실제 졸업요건은 학과/학교 규정에 따라 달라질 수 있으니 반드시 공식 안내를 함께 확인하라"는 문장을 한 줄로 덧붙여.
        """;
